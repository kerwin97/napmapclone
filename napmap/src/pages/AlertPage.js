...
type Props = {};
export default class AlertPage extends Component<Props> {
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity style={styles.button} onPress={() => {setTimeout(() => this.notif.localNotif(), 5000)}}><Text>Local Notification (now)</Text></TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={() => { this.notif.scheduleNotif() }}><Text>Schedule Notification in 5s</Text></TouchableOpacity>
